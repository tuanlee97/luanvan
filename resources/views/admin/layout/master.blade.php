...
<head>
		...
		<meta charset="UTF-8">
			<base href="{{asset('')}}">
		<title>Admin | VinaTour </title>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
  
		<meta name="keywords" content="Vina Admin Dashboard" />
		<meta name="description" content="Admin | VinaTour">
		<meta name="author" content="vinatour.tk">
