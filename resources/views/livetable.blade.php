 ...
 function fetch_data()
 {
  $.ajax({
   ...
   success:function(data)
   {
    ...
    {
     html +='<tr>';
     html +='<td contenteditable class="column_name" data-column_name="first_name" data-id="'+data[count].maquocgia+'">'+data[count].maquocgia+'</td>';
     html += '<td contenteditable class="column_name" data-column_name="last_name" data-id="'+data[count].maquocgia+'">'+data[count].tenquocgia+'</td>';
     html += '<td><button type="button" class="btn btn-danger btn-xs delete" id="'+data[count].maquocgia+'">Delete</button></td></tr>';
    }
    $('tbody').html(html);
   }
  });
